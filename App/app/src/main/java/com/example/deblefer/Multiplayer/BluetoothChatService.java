...
/**
 * This class does all the work for setting up and managing Bluetooth connections with other devices. It has a thread that listens for incoming connections, a thread for connecting with a device, and
...
public class BluetoothChatService {
	...
	public synchronized boolean start() {
		...
		try {
			...
			Log.e(TAG, "Error while starting the thread!", e);
			e.printStackTrace();
		}
		return success;
	}
	...
	private void connectionLost() {
		// Send a failure message back to the Activity
		Message msg = mHandler.obtainMessage(BluetoothChat.CONNECTION_LOST);
		Bundle bundle = new Bundle();
		bundle.putString(BluetoothChat.TOAST, "Connection with opponent lost / purposefully disconnected");
		msg.setData(bundle);
		mHandler.sendMessage(msg);
