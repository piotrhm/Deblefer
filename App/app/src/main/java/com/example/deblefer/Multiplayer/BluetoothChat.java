...
public class BluetoothChat extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bluetooth_activ);
		...
		if (mChatService != null) {
			...
			if (mChatService.getState() == BluetoothChatService.STATE_NONE) {
				...
				if (!mChatService.start()) {
					...
					Intent i = new Intent(BluetoothChat.this, LogIn.class);
					startActivity(i);
				}
			}
		}
	...
	private void setupChat() {
		...
		MultiplayerMessages.mChatService = mChatService;
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case MESSAGE_STATE_CHANGE:
					...
					switch (msg.arg1) {
						case BluetoothChatService.STATE_CONNECTED:
							...
							Intent i = new Intent(BluetoothChat.this, MultiplayerTable.class);
							startActivity(i);
							break;
				...
				case MESSAGE_READ:
					...
					MultiplayerMessages.inComingMessage = readMessage;
